...
class Cherokee < Formula
  ...
  url 'http://www.cherokee-project.com/download/pre-releases/cherokee-1.3.0A1.tar.gz'
  md5 '947d48e93a069d227ca28c48c1074d33'
    ...
    <<-EOS.undent
      ...
      for logging and runtime files.
       ...
       If this is your first install, automatically load on startup with:
          sudo cp #{prefix}/org.cherokee.webserver.plist #{ENV['HOME']}/Library/LaunchDaemons/org.cherokee.webserver.plist
          sudo launchctl load -w #{ENV['HOME']}/Library/LaunchDaemons/org.cherokee.webserver.plist

      If this is an upgrade and you already have the plist loaded:
          sudo launchctl unload -w #{ENV['HOME']}/Library/LaunchDaemons/org.cherokee.webserver.plist
          sudo cp #{prefix}/org.cherokee.webserver.plist #{ENV['HOME']}/Library/LaunchDaemons
          sudo launchctl load -w #{ENV['HOME']}/Library/LaunchDaemons/org.cherokee.webserver.plist
    EOS
  end
